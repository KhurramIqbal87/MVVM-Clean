//
//  HTTPStatusCodeHelper.swift
//  VBMBProductBase
//
//  Created by Arqam Owais on 03/06/2021.
//  Copyright © 2021 VeriPark. All rights reserved.
//

import Foundation

final public class HTTPStatusCodeHelper {
    
    class func codeDescription(statusCode: HTTPStatusCode)-> String {
        var codeDesc = ""
